      ...
      if (t && t.querySelectorAll) {
        ...
        sn(t).forEach(function (n) {
          ...
          if (void 0 === p.icons[l]) {
            if (p.missing[l])
              return (
                (d = { name: f, status: "missing", customisations: {} }),
                void (c[ze] = d)
              );
            if (!De({ provider: u, prefix: s, name: l })) {
            ...
            (d = { name: f, status: "loading", customisations: {} }),
              (c[ze] = d),
              (i = !0);
          } else {
  ...
  var yn = ["inline", "hFlip", "vFlip"],
    ...
    wn = {
      ...
      customisations: function (e, n) {
        ...
        if (
          (-1 !== (i ? i.split(/\s+/) : []).indexOf(mn) && (t.inline = !0),
          hn(e, "data-rotate"))
        ) {
          var o = (function (e, n) {
            void 0 === n && (n = 0);
    ...
    if (void 0 !== Fn.IconifyProviders) {
      ...
      if ("object" == typeof Pn && null !== Pn)
        for (var Ln in Pn) {
          ...
          try {
            var Nn = Pn[Ln];
            if ("object" != typeof Nn || !Nn || void 0 === Nn.resources)
              continue;
